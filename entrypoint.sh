...
# Si ODOO_DEV_MODULES está definido, instalar/actualizar esos módulos automáticamente
# Usamos -i en lugar de -u porque -i instala si no existe o actualiza si ya existe
if [ -n "$ODOO_DEV_MODULES" ]; then
  echo "Instalando/actualizando módulos: $ODOO_DEV_MODULES"
